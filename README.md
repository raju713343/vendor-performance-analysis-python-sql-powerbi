...
![Vendor Performance Dashboard](deliverables/vendor-performance-dashboard.png)
...
5. Open and run notebooks:
   - `notebooks/EDA_vendor_performance.ipynb`
   - `notebooks/Vendor Performance Analysis.ipynb`
6. Open Power BI Dashboard:
   - `deliverables/Vendor_Performance_Analysis_Dashboard.pbix`
